...
- [ ] 10-01-PLAN.md — Install dialog/checkbox/textarea; wrap the create/edit form in a shadcn Dialog; convert text/textarea/number/boolean/date field kinds (Popover+Calendar date-picker); fix entities-fundos.spec.ts
...
| 10. Entity Form Restyle & Feedback | v1.1 | 0/4 | Planned | - |
