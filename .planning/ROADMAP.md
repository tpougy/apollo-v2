...
- [ ] **Phase 24: Packaging & Installability** - Vendor the ANBIMA calendar into the package, embed a default `app_id`, and prove `uv build`/`uv tool install` works from a clean checkout outside the monorepo.
