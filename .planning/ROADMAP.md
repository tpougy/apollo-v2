...
- [x] **Phase 25: Public Auth Login** - Replace admin-token-based magic-code login with direct calls to InstantDB's public `/runtime/auth/*` endpoints, with zero CLI dependency on `INSTANT_APP_ADMIN_TOKEN` in normal operation (completed 2026-08-12).
...
| 25. Public Auth Login | v1.4 | 2/2 | Complete    | 2026-08-12 |
