...
- [x] **Phase 23: Focus Dialog System** - All 7 read-first focus dialogs, every Dashboard/section surface wired as a real keyboard-accessible `<button>`, max navigation depth of 2 (completed 2026-08-12)
...
- [x] 20-02-PLAN.md — RotinasSection (Instâncias/Templates tabs) + gotoNested templatesRotina branch (NEST-04)
- [x] 20-03-PLAN.md — ProjetosSection wiring: etapa-detail chip + "Todas as tarefas" orphan reachability (NEST-05)
- [x] 20-04-PLAN.md — e2e helper + migration of all remaining gotoNested(subtarefas) call sites (NEST-05)
- [x] 20-05-PLAN.md — Retire Shell.svelte's interim dropdown; NAV-02 regression fix (NEST-04, NEST-05)
...
- [x] 22-02-PLAN.md — RoutinesByFundo.svelte + MonthHeatmap.svelte: fundo-grouped routines with functional controls, 5-band monthly workload heatmap (DASH-04)
...
- [x] 23-06-PLAN.md — ProjectDialog (depth-2) + remaining ProjectStrips wiring + dashboardQuery.ts completeness fix (DLG-01, DLG-02, DLG-03)
- [x] 23-07-PLAN.md — Consolidated button-inventory audit + full-suite regression gate (DLG-02, DLG-03)
