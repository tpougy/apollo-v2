...
- [x] **NEST-04**: Seção Rotinas tem duas abas — Instâncias (default, `capabilities.create`/`.delete` continuam `false`, sem affordance de criar/excluir) e Templates (com parágrafo de contexto).
