...
pessoal para organizar entidades, projetos, rotinas e tarefas usando o
...
- Qualquer outro arquivo de apoio (notas, listas de entidades/rotinas a
...
as entidades/projetos/rotinas/tarefas que quer cadastrar (colar e-mails,
listas, o que for). O `CLAUDE.md` já instrui o assistente a:

- pedir os dados que faltarem em vez de inventar;
- criar as entidades na ordem certa (entidade → projeto → etapa → tarefa →
...
notas com nomes reais de entidades/clientes em texto livre, e mantenha o
repositório privado.
